...
export const products: Product[] = [
  ...
  P({ handle: "serim-coffee-auto", title: "세림 전자동 커피머신 오피스", brand: "serim", category: "office", price: 590000, moq: 1, lead: "3~5일", badge: "베스트", specs: ["원두 500g", "우유 거품", "터치 LCD", "일 200잔"], desc: "사무실 탕비실용. 원두 정기배송 연계.", look: "a sleek black bean-to-cup office coffee machine with a touch display" }),
